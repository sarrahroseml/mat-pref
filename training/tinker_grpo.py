...
Usage:
    ...
    python scripts/tinker_grpo.py load_checkpoint_path=runs/grpo_qwen3_8b_v2
...
SFT_CHECKPOINT = "tinker://0c0fcf40-13bc-54a8-b577-282da9852906:train:0/weights/final"
    ...
    return chz.Blueprint(rl_train.Config).apply(
        {
            ...
            "log_path": str(PROJECT_ROOT / "runs" / "grpo_qwen3_8b_v2"),
